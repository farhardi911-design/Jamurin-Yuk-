...
function checkoutViaWhatsApp() {
    ...
    // Checkout dibuat simpel: nama dan alamat wajib, catatan opsional.
    if (!name || !address) {
        openCart();
        alert('Isi nama dan alamat terlebih dahulu ya.');
        return;
    }
...
const PROMO_SUBSCRIBE_URL = 'https://script.google.com/macros/s/AKfycbxXBfQfUWkayPM8QIRlpzoeUolnDt3Drzj8VDydEW5v7uIv9_Vdi-G4hx-24mwahlGQ/exec';
// Endpoint Google Apps Script yang sama dipakai untuk mencatat pesanan ke Google Sheet.
const ORDER_SHEET_URL = 'https://script.google.com/macros/s/AKfycbxXBfQfUWkayPM8QIRlpzoeUolnDt3Drzj8VDydEW5v7uIv9_Vdi-G4hx-24mwahlGQ/exec';
